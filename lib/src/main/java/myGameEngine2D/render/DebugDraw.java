...
import myGameEngine2D.util.JMath;
...
public class DebugDraw {
	...
	// 6 floats per vertex, 2 verices per line
	private static float[] vertexArray = new float[MAX_LINES * 6 * 2];
	private static Shader shader = AssetPool.getShader("shaders/debugLine2D.glsl");
	...
	public static void draw() {
		...
		GL15.glBindBuffer(GL_ARRAY_BUFFER, vboID);
		GL15.glBufferSubData(GL_ARRAY_BUFFER, 0, Arrays.copyOfRange(vertexArray, 0, lines.size() * 6 * 2));
